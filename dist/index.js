...
let bpm = 120;
let volume = 0.7;
function playSound(audioCtx, destination, freq, time, duration = 0.15) {
...
function playKick(audioCtx, destination, time) {
    const oscillator = audioCtx.createOscillator();
    const gainNode = audioCtx.createGain();
...
function playSnare(audioCtx, destination, time) {
